...
common_params_context common_params_parser_init(common_params & params, llama_example ex, void(*print_usage)(int, char **)) {
    ...
    add_opt(common_arg(
        ...
        "- mirror: distribute, plus keep a full replica of large CPU weight buffers on every NUMA node so all reads are node-local (costs one extra copy of the CPU-resident weights in RAM)\n"
